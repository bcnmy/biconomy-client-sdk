...
import { SmartWalletFactoryContractV102__factory as SmartWalletFactoryFactoryContractV102 } from '../../typechain/src/ethers-v5/v1.0.2/factories/SmartWalletFactoryContractV102__factory'
...
import { EntryPointContractV102__factory as EntryPointFactoryContractV102 } from '../../typechain/src/ethers-v5/v1.0.2/factories/EntryPointContractV102__factory'
...
import EntryPointEthersContract_v1_0_2 from './EntryPointContract/v1.0.2/EntryPointEthersContract'
...
): SmartWalletContractEthers_v1_0_0 | SmartWalletContractEthers_v1_0_1 | SmartWalletContractEthers_v1_0_2 {
  let walletContract
...
export function getMultiSendContractInstance(
  ...
  // signer: Signer
  provider: JsonRpcProvider
): MultiSendEthersContract_v1_0_0 | MultiSendEthersContract_v1_0_1 | MultiSendEthersContract_v1_0_2 {
...
export function getSmartWalletFactoryContractInstance(
  ...
  switch (smartAccountVersion) {
    ...
    case '1.0.2':
      walletFactoryContract = SmartWalletFactoryFactoryContractV102.connect(
        contractAddress,
        provider
      )
...
export function getEntryPointFactoryContractInstance(
  ...
  contractAddress: string,
  provider: JsonRpcProvider
): EntryPointEthersContract_v1_0_0 | EntryPointEthersContract_v1_0_1 | EntryPointEthersContract_v1_0_2 {
  let walletFactoryContract
  ...
  switch (smartAccountVersion) {
    ...
    case '1.0.2':
      walletFactoryContract = EntryPointFactoryContractV102.connect(contractAddress, provider)
      return new EntryPointEthersContract_v1_0_2(walletFactoryContract)
  }
}
