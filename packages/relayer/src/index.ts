...
import { RelayResponse } from '@biconomy-sdk/core-types'
...
export interface Relayer {
    ...
    relay(rawTx: SignedTransaction, config: SmartAccountState, context: SmartAccountContext): Promise<RelayResponse>
