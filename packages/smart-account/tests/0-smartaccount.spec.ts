...
//       const signature = await smartAccount.signDirectAccountTransaction({
...
//         const hash: string = await smartAccount.sendTransactionWithFeeQuote({ tx: smartAccountTransaction })
...
//         smartAccount.setRelayer(relayer)
//         expect(smartAccount.relayer).to.be.equal(relayer)
//         const txHash: string = await smartAccount.sendTransactionWithFeeQuote({ tx: smartAccountTransaction })
