...
import { Web3Provider, ExternalProvider, BaseProvider, JsonRpcProvider, Networkish } from '@ethersproject/providers'
...
export class SmartAccountProvider extends BaseProvider {
    ...
    async constructSmartAccountTransactionResponse (tx: IWalletTransaction): Promise<TransactionResponse | null> {
        console.log(tx)
        return null
    }
