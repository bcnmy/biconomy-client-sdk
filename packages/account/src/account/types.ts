...
> = z.input<ReturnType<typeof createBaseSmartAccountParamsSchema<TTransport, TOwner>>>;

export type SimpleSmartAccountParams<
  TTransport extends SupportedTransports = Transport,
  TOwner extends SmartAccountSigner = SmartAccountSigner,
> = z.input<ReturnType<typeof SimpleSmartAccountParamsSchema<TTransport, TOwner>>>;
