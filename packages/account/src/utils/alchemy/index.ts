...
import type { BigNumberish, Percentage, PromiseOrValue, UserOperationRequest } from "../../types";
 ...
 */
export function getUserOperationHash(request: UserOperationRequest, entryPointAddress: Address, chainId: bigint): Hash {
...
export function defineReadOnly<T, K extends keyof T>(object: T, key: K, value: T[K]): void {
