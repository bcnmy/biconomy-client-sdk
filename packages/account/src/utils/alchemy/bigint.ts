 ...
 */
export const bigIntClamp = (value: BigNumberish, lower: BigNumberish | null | undefined, upper: BigNumberish | null | undefined) => {
 ...
 */
export const stringToIndex = (phrase: string): bigint => BigInt(keccak256(toHex(phrase)));
