 ...
 */
export function isValidRequest(request: UserOperationStruct): request is UserOperationRequest {
...
export function applyUserOpOverride(value: BigNumberish | undefined, override?: BigNumberish | Percentage): BigNumberish | undefined {
  if (override == null) {
    return value;
  }
  ...
  // percentage override
    ...
    return value != null ? bigIntPercent(value, BigInt(100 + override.percentage)) : value;
  }
}

export function applyUserOpFeeOption(value: BigNumberish | undefined, feeOption?: UserOperationFeeOptionsField): BigNumberish {
  if (feeOption == null) {
    return value ?? 0n;
  }
  return value != null
    ? bigIntClamp(feeOption.percentage ? bigIntPercent(value, BigInt(100 + feeOption.percentage)) : value, feeOption.min, feeOption.max)
    : feeOption.min ?? 0n;
}
