...
import type {
  EntryPoint_v005,
  EntryPoint_v005Interface,
} from "../../entrypoint/EntryPoint_v005";
...
type EntryPoint_v005ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EntryPoint_v005ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EntryPoint_v005__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<EntryPoint_v005>;
  }
  ...
  override attach(address: string): EntryPoint_v005 {
    return super.attach(address) as EntryPoint_v005;
  }
  override connect(signer: Signer): EntryPoint_v005__factory {
    return super.connect(signer) as EntryPoint_v005__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EntryPoint_v005Interface {
    return new utils.Interface(_abi) as EntryPoint_v005Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EntryPoint_v005 {
    return new Contract(address, _abi, signerOrProvider) as EntryPoint_v005;
  }
}
