...
import type {
  EntryPoint_v006,
  EntryPoint_v006Interface,
} from "../../entrypoint/EntryPoint_v006";
...
type EntryPoint_v006ConstructorParams =
  | [signer?: Signer]
  | ConstructorParameters<typeof ContractFactory>;

const isSuperArgs = (
  xs: EntryPoint_v006ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class EntryPoint_v006__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(overrides || {}) as Promise<EntryPoint_v006>;
  }
  ...
  override attach(address: string): EntryPoint_v006 {
    return super.attach(address) as EntryPoint_v006;
  }
  override connect(signer: Signer): EntryPoint_v006__factory {
    return super.connect(signer) as EntryPoint_v006__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): EntryPoint_v006Interface {
    return new utils.Interface(_abi) as EntryPoint_v006Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): EntryPoint_v006 {
    return new Contract(address, _abi, signerOrProvider) as EntryPoint_v006;
  }
}
