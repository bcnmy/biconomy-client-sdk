...
import type {
  ...
  MultiChainValidationModule_v100Interface,
} from "../../biconomy_v2.0.0/MultiChainValidationModule_v100";
...
const isSuperArgs = (
  xs: MultiChainValidationModule_v100ConstructorParams
): xs is ConstructorParameters<typeof ContractFactory> => xs.length > 1;

export class MultiChainValidationModule_v100__factory extends ContractFactory {
  ...
  override deploy(
    ...
    return super.deploy(
      overrides || {}
    ) as Promise<MultiChainValidationModule_v100>;
  }
  ...
  override attach(address: string): MultiChainValidationModule_v100 {
    return super.attach(address) as MultiChainValidationModule_v100;
  }
  override connect(signer: Signer): MultiChainValidationModule_v100__factory {
  ...
  static createInterface(): MultiChainValidationModule_v100Interface {
    return new utils.Interface(
      _abi
    ) as MultiChainValidationModule_v100Interface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as MultiChainValidationModule_v100;
  }
}
