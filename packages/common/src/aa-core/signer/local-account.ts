import { isHex, type HDAccount, type Hex, type LocalAccount, type PrivateKeyAccount } from "viem";
...
export class LocalAccountSigner<T extends HDAccount | PrivateKeyAccount | LocalAccount> implements SmartAccountSigner<T> {
  ...
  readonly signMessage: (_msg: string | Uint8Array) => Promise<`0x${string}`> = (msg) => {
