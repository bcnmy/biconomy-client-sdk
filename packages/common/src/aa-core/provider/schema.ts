...
export const createSmartAccountProviderConfigSchema = <TTransport extends SupportedTransports = Transport>() => {
  return z.object({
    rpcProvider: z.union([z.string(), createPublicErc4337ClientSchema<TTransport>()]),
    chain: ChainSchema,
    /**
