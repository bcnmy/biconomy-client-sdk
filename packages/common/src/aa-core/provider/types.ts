...
export type AccountMiddlewareOverrideFn<Req extends keyof UserOperationStruct = never, Opt extends keyof UserOperationStruct = never> = (
  struct: Deferrable<UserOperationStruct>,
  overrides?: UserOperationOverrides,
  feeOptions?: UserOperationFeeOptions,
) => Promise<WithRequired<UserOperationStruct, Req> & WithOptional<UserOperationStruct, Opt>>;

export type PaymasterAndDataMiddleware = AccountMiddlewareOverrideFn<
  "paymasterAndData",
  "callGasLimit" | "preVerificationGas" | "verificationGasLimit" | "maxFeePerGas" | "maxPriorityFeePerGas"
>;
...
export type SmartAccountProviderConfig<TTransport extends SupportedTransports = Transport> = z.input<
