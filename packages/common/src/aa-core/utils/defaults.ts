 ...
 * @throws if the chain doesn't have an address currently deployed
 */
export const getDefaultSimpleAccountFactoryAddress = (chain: Chain): Address => {
  switch (chain.id) {
    case mainnet.id:
    case polygon.id:
    case optimism.id:
...
export const getDefaultUserOperationFeeOptions = (chain: Chain): UserOperationFeeOptions => {
  return {
