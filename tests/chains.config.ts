...
type SupportedTestChain = "ganache" | "goerli" | "mumbai";
...
export const CHAIN_CONFIG: Record<SupportedTestChain, BaseChainConfig> = {
  ...
  goerli: {
    ...
    paymasterUrl: "https://paymaster.biconomy.io/api/v1/5/" + process.env.E2E_BICO_PAYMASTER_KEY_GOERLI!,
    viemChain: goerli,
...
export const E2E_TEST_CHAINS = [CHAIN_CONFIG.mumbai, CHAIN_CONFIG.goerli];
